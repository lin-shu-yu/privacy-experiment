...
for j in range(np.size(pixels, 1)):
    for k in range(math.ceil(num_channels/2)):
        ...
        pixels[channel_start:channel_end, j] = dark_blue; # make that section blue
...
final.save('knit_inflatable_07.bmp')
final.save('knit_inflatable_07.png')
...
pixels[-1,6:edge-6] = (0,100,0);
pixels[-1,width-edge+6:-6] = (0,100,0);
for i in range(num_channels):
    pixels[-1, (channel_med[i]-opening):(channel_med[i]+opening)] = (0,100,0);

# make checkerboard for knit openings
# create openings for edges
pixels[-2,6:edge-6:2] = (255,255,200);
pixels[-3,7:edge-5:2] = (255,255,200);
pixels[-2,width-edge+6:-6:2] = (255,255,200);
pixels[-3,width-edge+7:-5:2] = (255,255,200);
for i in range(num_channels):

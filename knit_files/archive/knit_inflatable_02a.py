...
opening = int(1); # make opening 2 st total
...
##### create new image #####
# color code
# dark blue (0,0,255) = knit front back
# light blue (175,200,225) = knit back front
# neon green (0,225,0) = knit back only 
# gray green (0, 200, 0) = transfer to back needles
# dark green (0, 100, 0) = transfer back to front
# red (255,0,0) = knit front
# yellow (255,255,200) = knit front, back float
...
pixels[::2, 5:-5:2] = (255,175,0)
pixels[1::2, 6:-6:2] = (255,175,0)
...
final.save('knit_inflatable_02a.bmp')
final.save('knit_inflatable_02a.png')
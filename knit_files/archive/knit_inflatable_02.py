##### inflatable knit #####
# from knit_inflatable_01
# edge -> 4cm for 1in rod
# at edge, 5 st instead of 3 st to prevent unraveling 
# change size of openings
# changing width to 60 cm -- 70 cm at [10 st / 2.5 cm] yielded 80 cm
# inc. min width to 3 cm
# inc. max width to 6 cm
...
final.save('knit_inflatable_02.bmp')
final.save('knit_inflatable_02.png')